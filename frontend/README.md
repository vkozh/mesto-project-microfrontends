...
Учебный проект студенки Яндекс.Практикума 39 потока Валерии Кожевниковой. Цель работы - добавление регистрации и авторизации на React.
...
- используются хуки: useEffect, useState, useContext, useHistory;
- используются Switch, Route из react-router-dom
- используется HOC ProtectedRoute
